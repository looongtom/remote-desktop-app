...
public class Ultraview extends javax.swing.JFrame {
    ...
    private List<ConnectHisFile> list;
...
//        Khởi tạo history table
        ...
        list = logConnectService.getLogFromFile(null);
...
//            System.out.println(connect.toString());
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon server/allow_connect.png"))); // NOI18N
        jButton1.setText("Cho phép kết nối");
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(ClientConnectServer_Btn, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(22, 22, 22))
        );
    ...
    private void ClientConnectServer_BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ClientConnectServer_BtnActionPerformed
        ...
        try {
            int passNum = Integer.parseInt(passClientText.getText());
            ...
            executorService.submit(new Runnable() {
                @Override
                public void run() {
                    ConnectClientServiceImpl connectService = new ConnectClientServiceImpl(ip, pass);
...
//            dispose();
            ...
            JOptionPane.showMessageDialog(this, "Password chỉ nhập số");
        }
...
//        connectService.InitConnectRemote();
        ...
        if (jCheckBoxShareDrive.isSelected()) {
            ...
            String passWindows = String.valueOf(jPasswordFieldPassword.getPassword());
            System.out.println("SHARE DRIVE for " + username);
            String temp = "net use %s: \\" + "\\" + "%s\\" + "%s /u:%s %s";
            List<String> listCommand = new ArrayList<>();
            if (jRadioButton1.isSelected()) {
                String nameDrive = "X";
                String nameShareDrive = String.valueOf(jRadioButton1.getText().charAt(0));
                String command = String.format(temp, nameDrive, ip, nameShareDrive, username, passWindows);
                listCommand.add(command);
            }
            if (jRadioButton2.isSelected()) {
                String nameDrive = "Y";
                String nameShareDrive = String.valueOf(jRadioButton2.getText().charAt(0));
                String command = String.format(temp, nameDrive, ip, nameShareDrive, username, passWindows);
                listCommand.add(command);
            }
            if (jRadioButton3.isSelected()) {
                String nameDrive = "Z";
                String nameShareDrive = String.valueOf(jRadioButton3.getText().charAt(0));
                String command = String.format(temp, nameDrive, ip, nameShareDrive, username, passWindows);
                listCommand.add(command);
            }
            connectService = new ConnectServerServiceImpl(pass, isShareDrive,listCommand);

//            connectService.shareDrives(listCommand);
            connectService.InitConnectRemote();
//            try {
...
//            }
            ...
            connectService = new ConnectServerServiceImpl(pass, isShareDrive,null);

            connectService.InitConnectRemote();
            // init server clip board
        }
    ...
    private void SearchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchBtnActionPerformed
        ...
        if (day != null) {
            ...
            list = logConnectService.getLogFromFile(dayStr + "_log.txt");
            showConnect(list);
        }
