...
//                    System.out.println(cPanel.getWidth() + ", " + cPanel.getHeight());

                    // Resize ảnh
                    /*BufferedImage resizedImage = new BufferedImage(cPanel.getWidth(), cPanel.getHeight(), image1.getType());
                    Graphics2D g2d = resizedImage.createGraphics();
                    g2d.drawImage(image1, 0, 0, cPanel.getWidth(), cPanel.getHeight(), null);
                    g2d.dispose();

                    Graphics graphics = cPanel.getGraphics();
                    graphics.drawImage(resizedImage, 0, 0, cPanel.getWidth(), cPanel.getHeight(), cPanel);*/

//					image1 = applyGaussianBlur(imageBytes, cPanel.getWidth(), cPanel.getHeight());
	...
	private BufferedImage applyGaussianBlur(byte[] imageBytes, int width, int height) {
